...
func DefaultConfiguration() Configuration {
	...
	return Configuration{Templates: map[TemplateID]Template{
		H2HRecord:          {ID: H2HRecord, Version: "v2", Required: []string{"team_a", "team_b", "format"}, Allowed: map[string][]any{"team_a": {}, "team_b": {}, "format": formats, "latest_matches": h2hLatest}, Defaults: map[string]any{"latest_matches": 10}, FreshFor: 15},
		...
		PlayerStatsAtVenue: {ID: PlayerStatsAtVenue, Version: "v2", Required: []string{"players", "venue", "format"}, Allowed: map[string][]any{"players": {}, "venue": {}, "format": formats, "window": window, "player_context": {}}, Defaults: map[string]any{"window": "since_2024"}, MinimumSample: 15, FreshFor: 60},
		...
		TeamPhaseProfiles:  {ID: TeamPhaseProfiles, Version: "v1", Required: []string{"team_a", "team_b", "format"}, Allowed: map[string][]any{"team_a": {}, "team_b": {}, "format": formats, "window": window}, Defaults: map[string]any{"window": "since_2024"}, MinimumSample: 10, FreshFor: 60},
